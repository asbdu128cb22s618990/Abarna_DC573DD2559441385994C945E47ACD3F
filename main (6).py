...
class BankAccount:
  def __init__(self, account_number, accournt_holder_name, initial_balance=0.0):
     self.__account_number =account_number
     self.__account_holder_name    =accournt_holder_name
  ...
  def withdraw(self,amount):
    if amount >0:
      ...
      print("Invalid withdrawal amount. Please withdraw a positive amoun")
